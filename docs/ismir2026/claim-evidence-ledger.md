...
| C1d | Signal–human dissociation: harmonic aligns with rater-consensus majorities better than CLAP cosine (7/9 vs 6/9; 12/19 vs 10/19 all pairs); role\_gap 3/3 on fired pairs; reported as descriptive (n=19, not significant) | `artifacts/human-signal-alignment/alignment.json` + `research/human_signal_alignment.py` | verified 2026-08-07 |
