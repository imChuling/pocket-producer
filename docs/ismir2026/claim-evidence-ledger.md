...
| C1e | Fusion gain replicates on deployed MS-CLAP space: hard\_similar 0.716→0.768 (+5.2pp), overall 0.864→0.877, both 5/5 seeds (one-sided sign test p=0.031); role\_gap disabled (text-embedding space mismatch), 5-signal condition only | `artifacts/fusion-msclap/fusion.json` | verified 2026-08-07 |
