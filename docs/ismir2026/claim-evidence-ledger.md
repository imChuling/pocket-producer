...
| C1e | Fusion gain replicates on deployed MS-CLAP space: hard\_similar 0.716→0.768 (+5.2pp), overall 0.864→0.877, both 5/5 seeds (one-sided sign test p=0.031). All 6 conditions ran; role\_gap held at 0 (LAION text prompts incompatible with 1024-dim space), so "cosine+session" = cosine+harmonic (0.8625, no gain vs cosine 0.8638) and "fusion-7sig" is effectively 6 signals (0.8769 ≈ fusion-5sig 0.8772) — session-signal null replicates too | `artifacts/fusion-msclap/fusion.json` | verified 2026-08-07 |
